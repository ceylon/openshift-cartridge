...
var $44x,$44y,$44z,$450;
if(function($451){if(!m$1.nn$($451))return false;return($44z=$451.$_get(0),$44x=$451.$_get(1),$450=$451.$_get(2),$44y=$451.$_get(3),true);}($44w)){
if(m$1.tpl$([24,0,0,0]).equals(m$1.tpl$([$44z,$44x,$450,$44y]))){
return time(0,0);
}
if(($452=$44z,$452.compare((0))!==m$1.smaller()&&$452.compare((23))!==m$1.larger())&&($453=$44x,$453.compare((0))!==m$1.smaller()&&$453.compare((59))!==m$1.larger())&&($454=$450,$454.compare((0))!==m$1.smaller()&&$454.compare((59))!==m$1.larger())&&($455=$44y,$455.compare((0))!==m$1.smaller()&&$455.compare((999))!==m$1.larger())){
return time($44z,$44x,$450,$44y);
}
}
return null;
}
