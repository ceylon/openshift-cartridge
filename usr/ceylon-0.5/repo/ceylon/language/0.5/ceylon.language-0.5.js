    ...
    if (Singleton.$$===undefined){
        ...
        (function($$singleton){
            ...
            $$singleton.find=function find(selecting$412){
                ...
                var $$singleton=this;
                return $$singleton.find($JsCallable(selecting$413,{Arguments:{t:Tuple,a:{Rest:{t:Empty},First:$$singleton.$$targs$$.Element,Element:$$singleton.$$targs$$.Element}},Return:{t:Boolean$}}));
            };
    ...
    if (LazySet.$$===undefined){
        ...
        (function($$lazySet){
            ...
            defineAttr($$lazySet,'size',function(){
                ...
                var sorted$521=$$lazySet.elems$518.$sort($JsCallable(byIncreasing($JsCallable(function (e$522){
                    var $$lazySet=this;
                    return e$522.hash;
    ...
    if (LazyMap.$$===undefined){
        ...
        (function($$lazyMap){
            ...
            $$lazyMap.get=function (key$561){
                var $$lazyMap=this;
                return (opt$562=$$lazyMap.entries$560.find($JsCallable(function (e$563){
                    var $$lazyMap=this;
                    return e$563.key.equals(key$561);
                },{Arguments:{t:Tuple,a:{Rest:{t:Empty},First:{t:Entry,a:{Key:$$lazyMap.$$targs$$.Key,Item:$$lazyMap.$$targs$$.Item}},Element:{t:Entry,a:{Key:$$lazyMap.$$targs$$.Key,Item:$$lazyMap.$$targs$$.Item}}}},Return:{t:Boolean$}})),opt$562!==null?opt$562.item:null);
            };
...
var sort=function (elements$685,$$$mptypes){
    return internalSort($JsCallable(byIncreasing($JsCallable(function (e$686){
        return e$686;
    },{Arguments:{t:Tuple,a:{Rest:{t:Empty},First:$$$mptypes.Element,Element:$$$mptypes.Element}},Return:$$$mptypes.Element}),{Value:$$$mptypes.Element,Element:$$$mptypes.Element}),{Arguments:{t:Tuple,a:{Rest:{t:Tuple,a:{Rest:{t:Empty},First:$$$mptypes.Element,Element:$$$mptypes.Element}},First:$$$mptypes.Element,Element:$$$mptypes.Element}},Return:{t:Comparison}}),elements$685,{Element:$$$mptypes.Element});
};
exports.sort=sort;
...
var compose=function (x$689,y$690,$$$mptypes){
    return flatten($JsCallable(function (args$691){
        return x$689(unflatten($JsCallable(y$690,{Arguments:$$$mptypes.Args,Return:$$$mptypes.Y}),{Args:$$$mptypes.Args,Return:$$$mptypes.Y})(args$691));
